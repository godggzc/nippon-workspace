<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户配置id" align="center" prop="configId" />
...
<script>
import { listConfig, getConfig, delConfig, addConfig, updateConfig } from "@/api/work/config";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除itop用户配置编号为"' + configIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('work/config/export', {
        ...this.queryParams
